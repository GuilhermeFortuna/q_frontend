...
export function StrategyBuilderWorkspace() {
  ...
  return (
    <div className="animate-fade-in-up mx-auto flex h-[calc(100dvh-4.5rem-7rem)] min-h-[36rem] w-full max-w-6xl flex-col gap-4 overflow-hidden">
      ...
      <Panel living className="flex min-h-0 flex-1 flex-col p-4">
        <AiStrategyPanel
          session={session}
          hideHeader
          fillHeight
          draftHeader={
            <div className="space-y-3" data-testid="ai-strategy-draft-header">
