  ...
  return (
    <div className="relative flex min-h-full flex-col">
      ...
      <header
        ...
        className="vt-header border-brass-600/15 bg-espresso-950/40 flex items-center justify-between border-b px-6 py-2.5 shadow-[0_4px_30px_rgba(0,0,0,0.4)] backdrop-blur-md select-none"
      >
